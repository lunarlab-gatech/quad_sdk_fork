...
#else
  #define CASADI_PREFIX(ID) eval_jac_g_go2test_ ## ID
#endif
...
/* eval_jac_g_go2test:(w[36],p[14])->(jac_g[28x36,132nz]) */
...
extern "C" CASADI_SYMBOL_EXPORT int eval_jac_g_go2test(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem){
  return casadi_f0(arg, res, iw, w, mem);
}

extern "C" CASADI_SYMBOL_EXPORT int eval_jac_g_go2test_alloc_mem(void) {
  return 0;
}

extern "C" CASADI_SYMBOL_EXPORT int eval_jac_g_go2test_init_mem(int mem) {
  return 0;
}

extern "C" CASADI_SYMBOL_EXPORT void eval_jac_g_go2test_free_mem(int mem) {
}

extern "C" CASADI_SYMBOL_EXPORT int eval_jac_g_go2test_checkout(void) {
  return 0;
}

extern "C" CASADI_SYMBOL_EXPORT void eval_jac_g_go2test_release(int mem) {
}

extern "C" CASADI_SYMBOL_EXPORT void eval_jac_g_go2test_incref(void) {
}

extern "C" CASADI_SYMBOL_EXPORT void eval_jac_g_go2test_decref(void) {
}

extern "C" CASADI_SYMBOL_EXPORT casadi_int eval_jac_g_go2test_n_in(void) { return 2;}

extern "C" CASADI_SYMBOL_EXPORT casadi_int eval_jac_g_go2test_n_out(void) { return 1;}

extern "C" CASADI_SYMBOL_EXPORT casadi_real eval_jac_g_go2test_default_in(casadi_int i){
  switch (i) {
    default: return 0;
  }
}

extern "C" CASADI_SYMBOL_EXPORT const char* eval_jac_g_go2test_name_in(casadi_int i){
  switch (i) {
    case 0: return "w";
    case 1: return "p";
    default: return 0;
...
extern "C" CASADI_SYMBOL_EXPORT const char* eval_jac_g_go2test_name_out(casadi_int i){
  switch (i) {
    case 0: return "jac_g";
    default: return 0;
  }
...
extern "C" CASADI_SYMBOL_EXPORT const casadi_int* eval_jac_g_go2test_sparsity_in(casadi_int i) {
  switch (i) {
...
extern "C" CASADI_SYMBOL_EXPORT const casadi_int* eval_jac_g_go2test_sparsity_out(casadi_int i) {
  switch (i) {
...
extern "C" CASADI_SYMBOL_EXPORT int eval_jac_g_go2test_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
  if (sz_arg) *sz_arg = 2;
  if (sz_res) *sz_res = 1;
  if (sz_iw) *sz_iw = 0;
  if (sz_w) *sz_w = 0;
